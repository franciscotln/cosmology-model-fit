...
@njit
def get_fz(params):
    z_pivot = 0.739 # corr(ln(fp), n) = 5.4e-03
...
# n_cc = 1.52 +0.50 -0.58
#
# log likelihood (MAP): -841.65
# DOF: 1621
# ---------------------------------

# Flat wCDM: w(z) = w
# H0 = 67.6 ± 3.0 km/s/Mpc
# Ωm = 0.304 +0.049 -0.039
# Ωm h^2 = 0.138 +0.022 -0.019
# w0 = -0.94 +0.12 -0.10 (prior ~ U[-2, 0])
#
# M = -19.426 ± 0.097 mag
# ln(fp_cc) = -0.50 ± 0.18
# n_cc = 1.54 ± 0.56
#
# log likelihood (MAP): -841.50
# DOF: 1620
# ---------------------------------
