...
σ8 = 0.790 +0.019 -0.019
S8 = 0.755 +0.029 -0.028
w0: -1
f = 1
chi2 = 34.72
log likelihood = 95.3
...
flat wCDM
Ωm = 0.255 +0.023 -0.024
σ8 = 0.870 +0.072 -0.052
S8 = 0.807 +0.038 -0.035
w0 = -0.756 +0.130 -0.131 (prior: U(-1.4, 0.0))
f = 1.35 +0.12 -0.12
chi2 = 60.27
...
w0 = -0.705 +0.160 -0.161 (prior: U(-1.0, 0.0))
f = 1.34 +0.12 -0.12
chi2 = 60.56
log likelihood = 101.0
log evidence = 91.6
degs of freedom = 59
"""
