...
Ωm = 0.316 +0.033 -0.030
σ8 = 0.786 +0.020 -0.019
S8 = 0.805 +0.037 -0.036
g8 = 0.798 +0.032 -0.031
chi2 = 28.69
log likelihood = -14.3
degs of freedom = 59
chi2/dof = 0.49
...
Ωm = 0.315 +0.023 -0.021
σ8 = 0.785 +0.014 -0.014
S8 = 0.804 +0.025 -0.025
g8 = 0.796 +0.022 -0.021
f_err = 1.44 +0.13 -0.13
chi2 = 61.02
log likelihood = -7.1
degs of freedom = 58
chi2/dof = 1.05
...
without f_err:
Ωm = 0.305 +0.037 -0.036
σ8 = 0.814 +0.077 -0.055
S8 = 0.826 +0.050 -0.049
g8 = 0.797 +0.033 -0.031
w0 = -0.885 +0.196 -0.233 (prior ~ U(-2, 0))
chi2 = 28.36
log likelihood = -14.2
degs of freedom = 58
chi2/dof = 0.49
...
with f_err:
Ωm = 0.303 +0.026 -0.026
σ8 = 0.819 +0.054 -0.042
S8 = 0.826 +0.037 -0.035
g8 = 0.794 +0.023 -0.022
f_err = 1.43 +0.13 -0.13
w0 = -0.871 +0.144 -0.156 (prior ~ U(-2, 0))
chi2 = 61.96
log likelihood = -6.8
degs of freedom = 57
chi2/dof = 1.09
...
without f_err:
Ωm = 0.316 +0.033 -0.030
σ8 = 0.814 +0.037 -0.028
S8 = 0.839 +0.044 -0.042
g8 = 0.792 +0.032 -0.030
w0 = -0.752 +0.203 -0.164 (prior ~ U(-1, 0))
chi2 = 28.43
log likelihood = -14.2
degs of freedom = 58
chi2/dof = 0.49
...
with f_err:
Ωm = 0.315 +0.023 -0.022
σ8 = 0.809 +0.026 -0.021
S8 = 0.830 +0.032 -0.030
g8 = 0.791 +0.023 -0.021
f_err = 1.44 +0.13 -0.13
w0 = -0.795 +0.160 -0.133 (prior ~ U(-1, 0))
chi2 = 62.89
log likelihood = -6.8
degs of freedom = 57
chi2/dof = 1.10
