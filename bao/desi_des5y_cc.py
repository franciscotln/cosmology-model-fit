...
def chi_squared(params):
    ...
    scaled_error = dH_cc_vals * f
    chi_cc = np.sum(cc_delta**2 / scaled_error**2)
...
def main():
    ...
    labels = ["ΔM", r"$H_0$", r"$r_d$", "Ωm", r"$w_0$", r"$w_a$", "f"]
    corner.corner(
        samples,
        labels=labels,
...
ΔM: -0.058 +0.0361 -0.0365 mag
H0: 67.25 +1.22 -1.22 km/s/Mpc
r_d: 146.96 +2.47 -2.40 Mpc
Ωm: 0.306 +0.008 -0.008
w0: -0.859 +0.042 -0.042 (3.36 sigma)
wa: 0
f_cc: 0.711 +0.103 -0.083 (2.81 - 3.48 sigma)
Chi squared: 1676.7605
Degrees of freedom: 1774
