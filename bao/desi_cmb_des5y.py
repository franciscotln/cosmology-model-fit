...
ΔM_inf: -0.0712 ± 0.0089 mag (0.4 sigma agreement with DESI+CMB+Union3.1, it has to be by definition)
z_c: 0.037 +0.011 -0.009 (prior ~ U(0, 0.12))
...
Log evidence: -840.8 (Δ logZ = 2.2 against constant M)
