...
def chi_squared(theta):
    thetastar, _, omh2 = cmb.DISTANCE_PRIORS - cmb.cmb_distances(theta[2], theta[3], theta)
    delta_cmb = np.array([thetastar, omh2])
...
def main():
    ...
    DOF = 2 + len(bao_data) + len(z_cmb) - len(best_fit)
...
# z_cosmo = -1 + (1 + z) / (1 + v/c)
#
# v: -3.22 +1.05 -1.05 x 100 km/s
# ΔM: -0.020 +0.021 -0.022 mag
# H0: 69.64 +0.81 -0.83 km/s/Mpc
# ωb: 0.02389 +0.00093 -0.00095
# ωc: 0.1172 +0.0007 -0.0006
# ωm: 0.1418 +0.0012 -0.0012
# Ωm: 0.292 +0.006 -0.006
# z_d: 1063.28 +2.01 -2.14
# r_d: 146.16 +1.05 -1.01 Mpc
# Chi squared: 33.14 (3.08 sigma significance)
# Log Evidence: -36.62 (Δ logZ = 2.86 in favour of flow correction)
# Degs of freedom: 32
# ---------------------------------
