...
ΔM: -0.0635 ± 0.0079 mag
v: -1.72 ± 0.62 (prior ~ U(-6.0, 2.0)) x 100 km/s
v / (z_cut=0.1): -1720 ± 620 km/s
...
zd: 1060.22 ± 0.23
rd: 147.60 ± 0.19 Mpc
χ2 (MAP): 1643.56 (2.77 sigmas away from no corrections)
Log evidence: -841.6 (ΔlogZ = 2.2 in favour of corrections)
