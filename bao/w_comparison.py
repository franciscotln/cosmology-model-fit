...
desi_union3 = {
    "name": "DESI+Union3",
    "non_linear": {
        "central": [0.3259, -0.6964, -1.1680],
        "lower": [0.3259 - 0.0170, -0.7383 + 0.1174, -1.1680 + 0.1816],
        "upper": [0.3259 + 0.0158, -0.7383 - 0.1124, -1.1680 - 0.1788],
    },
    "CPL": {
...
desi_des5y = {
    "name": "DESI+DES5Y",
    "non_linear": {
        "central": [0.3169, -0.7868, -1.1155],
        "lower": [0.3169 - 0.0144, -0.7868 + 0.0756, -1.1155 + 0.1623],
        "upper": [0.3169 + 0.0129, -0.7868 - 0.0711, -1.1155 - 0.1653],
    },
    "CPL": {
...
desi_pantheon = {
    "name": "DESI+Pantheon+",
    "non_linear": {
        "central": [0.3022, -0.8959, -0.9731],
        "lower": [0.3022 - 0.0165, -0.8959 + 0.0650, -0.9731 + 0.1610],
        "upper": [0.3022 + 0.0137, -0.8959 - 0.0630, -0.9731 - 0.1582],
    },
    "CPL": {
