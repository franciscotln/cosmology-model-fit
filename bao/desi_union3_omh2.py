...
Flat ΛCDM: w(z) = -1
rd: 147.30 +1.29 -1.28 Mpc
H0: 68.59 +0.99 -0.97 km/s/Mpc
...
Flat wCDM: w(z) = w0
rd: 142.52 +2.42 -2.56 Mpc
H0: 69.32 +1.11 -1.07 km/s/Mpc
Ωm: 0.298 +0.009 -0.009
w0: -0.865 +0.051 -0.052 (prior width 1.5: -1.5 to 0.0)
wa: 0
Chi squared: 32.1
Log evidence: -30.9 (Δ logZ = 0.8 against ΛCDM)
Degs of freedom: 31

===============================

Flat wzCDM: w(z) = -1 + 4 * (1 + w0) / (1 + 3 * (1 + z)**3)
rd: 144.47 +1.63 -1.60 Mpc
H0: 67.75 +1.01 -1.00 km/s/Mpc
Ωm: 0.312 +0.009 -0.009
w0: -0.774 +0.074 -0.076 (prior width 1.5: -1.5 to 0.0)
wa: d w(z)/dz at z=0 = -(9/4) * (1 + w0)
Chi squared: 30.1
Log evidence: -29.5 (Δ logZ = 2.2 against ΛCDM)
Degs of freedom: 31

===============================

Flat w0waCDM: w(z) = w0 + wa * z / (1 + z)
rd: 148.14 +2.41 -3.07 Mpc
H0: 65.75 +1.86 -1.52 km/s/Mpc
Ωm: 0.331 +0.016 -0.018
w0: -0.697 +0.114 -0.110 (prior width 1.5: -1.5 to 0.0)
wa: -1.01 +0.56 -0.56 (prior width 7.0: -4.5 to 2.5)
Chi squared: 28.8
Log evidence: -30.6 (Δ logZ = 1.1 against ΛCDM)
Degs of freedom: 30
"""
